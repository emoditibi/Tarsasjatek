...
function Sorokosszege() 
{
    ...
    console.log(elemek);
    console.log(elsosor);
    console.log(masodiksor);
    console.log(harmadiksor);
    console.log(negyediksor);
    console.log(otodiksor);
    */
    var osszeguk = new Array();
    for (let z = 0; z < 5; z++) 
    {
        /*
        let ideiglenes = 0;
        */
        ...
        {
            /*
            let value = cellak[z*6+y].info.value;
            ideiglenes += value;
            */
            osszeg += cellak[z*6+y].info.value;
            
        }   
        /*
        osszeguk.push(ideiglenes);
        */
        console.log(osszeg);
    }
    console.log(osszeguk);
